...
Scenario: Display ranking
    ...
    And I click on my ranking page
    Then I should see a list my followers ranked by influence 

Scenario: Sort ranking

    Given I am on my user profile
    And I click on my ranking
    The I should see a user with a higher ranking on top
