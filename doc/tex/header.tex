...
\newcommand{\python}[4]{\vspace{10pt}\inputminted[firstline=#2,
                                 ...
                                 bgcolor=bg,
                                 linenos]{python}{#1}}
\newcommand{\rlang}[4]{\vspace{10pt}\inputminted[firstline=#2,
                                 lastline=#3,
                                 firstnumber=#2,
                                 gobble=#4,
                                 frame=single,
...
\fancyhead[LE,LO]{Twitter Analysis}                                  %  Adds header to left
\fancyhead[RE,RO]{Brandon Cooper, William Farmer, Kevin Gomez}                                       %  Adds header to right
\cfoot{\mlptikz[size=0.25in, text=on, textposx=0, textposy=0, textvalue=\thepage, textscale=0.75in]{applejack}}
\lfoot{APPM 3310}
\rfoot{Beylkin}
\title{Twitter Analysis}
\author{Brandon Cooper\\William Farmer\\Kevin Gomez}
