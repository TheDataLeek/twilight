...
The primary languages used are Ruby on Rails and Python, with heavy Javascript
help.

The project is hosted at www.will-farmer.com with source code available at
www.github.com/willzfarmer/twilight.
